...
export const ITEMBASE_IDS = itemBaseIds;
export const ITEMAFFIX_IDS = itemAffixIds;
...
export const ITEMBASE_ID_SCHEMA = itemBaseIdSchema;
export const ITEMAFFIX_ID_SCHEMA = itemAffixIdSchema;
