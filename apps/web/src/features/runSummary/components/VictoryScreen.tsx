			...
			<GameLayout>
				<div className="flex min-h-0 flex-1 items-center justify-center bg-bg-base px-4 text-base text-text">
					<section className="grid w-full max-w-xl justify-items-center gap-6 text-center">
						<h1 className="text-base uppercase tracking-widest text-success">
							Victory
						</h1>
			...
			<div className="min-h-0 flex-1 overflow-y-auto bg-bg-base px-4 py-6 text-base text-text">
				<section className="mx-auto grid min-h-full w-full max-w-3xl content-center gap-6">
					<header className="grid gap-3 border-b-2 border-border pb-4 text-center">
						<p className="uppercase tracking-widest text-success">Victory</p>
						<h1 className="text-base text-primary">The Ladder Is Broken</h1>
						<p className="mx-auto max-w-2xl text-text-muted">
							The final foe has fallen. The world beyond battle 100 waits, but this
							hero has earned their rest.
						</p>
					</header>
					...
					{finalMomentEntries.length > 0 && (
						<section
							className="grid gap-3 border border-border bg-bg-elevated p-4"
...
function SummaryStat({ label, value }: SummaryStatProps) {
	return (
		<div className="grid gap-1 border border-border bg-bg-elevated p-3 text-center">
